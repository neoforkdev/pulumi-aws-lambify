 ...
 */
export async function discoverApiRoutes(apiDirectory: string): Promise<DiscoveredRoute[]> {
 ...
 */
async function scanForRoutes(directory: string, relativePath: string = ''): Promise<DiscoveredRoute[]> {
